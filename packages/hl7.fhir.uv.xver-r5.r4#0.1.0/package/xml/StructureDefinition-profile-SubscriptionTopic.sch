...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/artifact-url|5.2.0']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/artifact-url|5.2.0': minimum cardinality of 'extension' is 1</sch:assert>
