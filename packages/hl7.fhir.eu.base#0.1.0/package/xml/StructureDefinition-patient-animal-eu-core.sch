...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:extension">
      <sch:assert test="count(f:extension[@url = 'species']) &gt;= 1">extension with URL = 'species': minimum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'breed']) &lt;= 1">extension with URL = 'breed': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'genderStatus']) &lt;= 1">extension with URL = 'genderStatus': maximum cardinality of 'extension' is 1</sch:assert>
